      ...
      >
        ...
        <div style={{ padding: '0 2rem' }}>
          ...
          <div className="flex gap-4">
            {/* Line Numbers */}
            <div className="text-gray-600 text-xs leading-relaxed" style={{ paddingTop: '1px', width: '36px', flexShrink: 0 }}>
                      ...
                      <div key={index} className="mb-4">
                        <div className="mb-2">
                          <div className="flex justify-between items-start mb-1 gap-2">
                            ...
                            <span className="text-green-400 font-bold text-sm prevent-period-break whitespace-nowrap">{job.period}</span>
                          </div>
                    ...
                    <div className="space-y-4">
                      {section.items?.map((item, itemIndex) => (
                        <div key={item.id} className="mb-4">
                          <div className="mb-2">
                            <div className="flex justify-between items-start mb-1 gap-2">
                              {item.title && <h3 className="text-white font-semibold text-sm flex-1 min-w-0">{item.title}</h3>}
                              {item.period && <span className="text-green-400 font-bold text-sm prevent-period-break whitespace-nowrap shrink-0">{item.period}</span>}
                            </div>
                          </div>
